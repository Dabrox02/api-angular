...
export class PexelApiService {
  ...
  API_URL: string = 'https://api.pexels.com/v1/search?query=';
  ...
  getData(query: string): Observable<any> {  // Esta línea define un método llamado getData que devuelve un Observable de cualquier tipo
    ...
    return this.http.get<any>(`${this.API_URL}${query}&per_page=5`, { headers }).pipe(res => res);
